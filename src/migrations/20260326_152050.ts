...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_careers_employment_type" AS ENUM('full-time', 'part-time', 'per-diem', 'contract');
  CREATE TYPE "public"."enum_careers_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__careers_v_version_employment_type" AS ENUM('full-time', 'part-time', 'per-diem', 'contract');
  ...
  CREATE TABLE "careers" (
  	...
  	"title" varchar,
  	"department" varchar,
  	"location" varchar DEFAULT 'Grand Rapids, MI',
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"users_id" integer,
  	"careers_id" integer,
  	"career_applications_id" integer,
  ...
  ALTER TABLE "career_applications" ADD CONSTRAINT "career_applications_position_id_careers_id_fk" FOREIGN KEY ("position_id") REFERENCES "public"."careers"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "career_applications_position_idx" ON "career_applications" USING btree ("position_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_career_applications_application_status";
