...
export interface CareInBloomEmailProps {
  senderName: string
  senderEmail: string
  senderPhone?: string
...
export const CareInBloomEmail = ({
  ...
  message,
  siteUrl,
}: CareInBloomEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>
        Care in Bloom request from {senderName} for {recipientName}
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={banner}>
            <Text style={bannerLabel}>Care in Bloom Request</Text>
            <Heading style={bannerTitle}>A little sunshine is on its way 🌸</Heading>
          </Section>

          <Section style={content}>
            <Text style={sectionTitle}>Sender</Text>

            <Row style={infoRow}>
              <Column style={labelCol}>Name</Column>
              <Column style={valueCol}>{senderName}</Column>
            </Row>
            <Hr style={divider} />
            ...
            <Row style={infoRow}>
              <Column style={labelCol}>Name</Column>
              <Column style={valueCol}>{recipientName}</Column>
            </Row>
            <Hr style={divider} />

            <Row style={infoRow}>
              <Column style={labelCol}>Location</Column>
              <Column style={valueCol}>{recipientLocation}</Column>
            </Row>
          ...
          <Section style={footer}>
            <Text style={footerText}>
              ...
              <Link href={`${siteUrl}/care-in-bloom`} style={footerLink}>
                Care in Bloom page
              </Link>
              .
            </Text>
...
export default CareInBloomEmail
